...
function Bottle({ initial, glas, cap, liquid, children, ...props }) {
  ...
  const [normal, normal2] = useTextureLoader(["/225_norm.jpg", "/190_norm.jpeg"])
...
export default function Bottles(props) {
  ...
  return (
    <group ref={group} {...props} dispose={null} scale={[0.1, 0.1, 0.1]}>
      <Bottle initial={-40} position={[0, 0, 0]} glas="Untitled.052_0" cap="Untitled.052_1" liquid="Untitled.052_2">
